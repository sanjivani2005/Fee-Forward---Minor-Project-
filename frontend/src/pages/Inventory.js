...
>
  Become a Food Donation Volunteer – Make an Impact Today! 🌟 
  Imagine a world where no one goes to bed hungry, and no food is wasted. As a food donation volunteer, you have the power to make that world a reality. By simply giving your time, you can help rescue surplus food from businesses, households, and local events and deliver it to those in need. Not only will you be fighting hunger and reducing food waste, but you'll also experience the incredible satisfaction of knowing that your actions are making a tangible difference in people's lives. Volunteering is easy, rewarding, and a chance to join a community of like-minded individuals who share your passion for giving back. Whether you're collecting, organizing, or spreading the word, every effort counts. So, are you ready to help feed those in need and change lives? 
  <br />
  <br />
  <a
    href="https://forms.gle/GuD2vRAEoaJKVVX6A"
    target="_blank"
    rel="noopener noreferrer"
    style={{ textDecoration: "none", color: "blue" }} // Change the color here
  >
